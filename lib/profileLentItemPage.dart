...
class ProfileLentItemPage extends StatefulWidget{
  @override
  _ProfileLentItemPageState createState() => _ProfileLentItemPageState();
}

class _ProfileLentItemPageState extends State<ProfileLentItemPage>{
  int index=3;
  ...
  Future getResourceList() async{
    ...
    Firestore.instance.collection('Resource').snapshots().listen((data){
        data.documents.forEach((doc) {
          ...
          if (_userEmail==User.currentUserEmail){
            if (mounted)
